...
def contentsdetail(request, id):
    ...
    nidCoinContract_address = Web3.toChecksumAddress("0xa56a160c5e18e7f35a3da7046b177b1b3e0151c2")
    ncc = w3.eth.contract(address=nidCoinContract_address, abi=[ { constant: True,
    inputs: [],
    name: 'name',
    outputs: [ [Object] ],
    payable: False,
...
def contentsupload(request):
    if request.method == 'GET':
        ...
        w3 = Web3(HTTPProvider(rpc_url))
        print("시작 트랜젝션")
        contentsMasterContract_address = Web3.toChecksumAddress("0xb6becca291012a67ec9e1f571ae584c497a29ae1")

        cmc = w3.eth.contract(address=contentsMasterContract_address, abi= [ { constant: False,
    inputs: [ [Object], [Object] ],
    name: 'addContents',
    outputs: [],
    payable: False,
